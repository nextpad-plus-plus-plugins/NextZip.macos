...
- ✅ Dockable two-pane File-Manager (`NextZipController`): a filesystem browser
...
- **RAR is extraction-only** — the RAR compression algorithm is proprietary and
  cannot be created by anything but WinRAR (unRAR license). NextZip never offers
  "create RAR".
